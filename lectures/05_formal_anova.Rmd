...
```{r, warning=FALSE}
qplot(x = rf(5000, 3, 4), geom = "density") +
  xlim(0, 20)
```

Finding the p-value for our test statistic
...
You will learn much more about what are called **post hoc tests** in Chapter 11. But basically, we can do pairwise comparisons, think independent samples t-test between conditions.
